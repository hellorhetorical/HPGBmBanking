(() => {
  ...
  angular.module("hpgbmbanking").controller("AccountsController", function () {
      const vm = this;
      vm.title = "Accounts";
      vm.subtitle = "Add account lists and balances.";
      vm.accounts = getMockList(MOCK_DATA.ACCOUNTS_PAGE_ACCOUNTS);
