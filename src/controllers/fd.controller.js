(() => {
  ...
  angular.module("hpgbmbanking").controller("FdController", function () {
      const vm = this;
      vm.title = "FD Calculator";
      vm.subtitle = "Estimate maturity value for fixed deposits.";
      vm.form = {
        principal: "",
        rate: "",
      ...
      vm.calculate = function () {
        ...
        const total = principal * Math.pow(1 + rateAnnual / (100 * n), n * years);
