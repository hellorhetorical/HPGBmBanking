(() => {
  ...
  angular.module("hpgbmbanking").controller("MPassbookController", [
      function () {
      const vm = this;
      vm.title = "mPassbook";
      vm.subtitle = "Track your passbook entries anytime.";
      vm.accounts = getMockList(MOCK_DATA.MPASSBOOK_ACCOUNTS);
      vm.passbookForm = {
      ...
      vm.entries = getMockList(MOCK_DATA.MPASSBOOK_ENTRIES);
      vm.visibleEntries = 3;
      vm.loadMoreEntries = function () {
        vm.visibleEntries = Math.min(vm.visibleEntries + 3, vm.entries.length);
      };
    },
    ]);
})();
