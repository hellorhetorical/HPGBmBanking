(() => {
  ...
  angular.module("hpgbmbanking").controller("DepositManagementMoreController", [
      "$location",
      function ($location) {
      const vm = this;
      vm.title = "Deposit Management";
      vm.subtitle = "Explore every fixed and recurring deposit service in one place.";
      vm.actions = DEFAULT_DEPOSIT_ACTIONS;
