(() => {
  ...
  angular.module("hpgbmbanking").controller("SupportController", function () {
      const vm = this;
      vm.title = "Support";
      vm.subtitle = "Get help, contact us, and find quick resources.";
      vm.tollfree = DEFAULT_TOLL_FREE || "tollfree";
      vm.supportEmail = DEFAULT_SUPPORT_EMAIL || "supportemail";
