(() => {
  ...
  angular.module("hpgbmbanking").controller("LoansController", function () {
      const vm = this;
      vm.title = "Loans";
      vm.subtitle = "Explore loan offers and track applications.";
      vm.bankShortName = BANK_SHORT_NAME || "bankshortname";
      vm.startApplicationUrl = START_APPLICATION_URL || "";
    });
})();
