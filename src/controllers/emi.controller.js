(() => {
  ...
  angular.module("hpgbmbanking").controller("EmiController", function () {
      const vm = this;
      vm.title = "EMI Calculator";
      vm.subtitle = "Quickly estimate your monthly payment.";
      vm.form = {
        amount: "",
        months: "",
        rate: "",
      ...
      vm.calculate = function () {
        ...
        if (!principal || !months || !rateAnnual || months <= 0) {
          vm.result = null;
          return;
        }
        ...
        const adjustedEmi = emi + (isNaN(extra) ? 0 : extra);
